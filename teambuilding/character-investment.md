...
If you're not sure what artifacts/weapons/builds are best for a character, check out the Genshin Helper Team's [Build Guide](%20https://docs.google.com/spreadsheets/d/e/2PACX-1vRq-sQxkvdbvaJtQAGG6iVz2q2UN9FCKZ8Mkyis87QHFptcOU3ViLh0_PJyMxFSgwJZrd10kbYpQFl1/pubhtml)!
...
| :--- | :--- | :--- | :--- |
| ![](../.gitbook/assets/exile_flower.png) | Exile | 2 | Energy Recharge +20% |
| ![](../.gitbook/assets/scholar_flower.png) | Scholar | 2 | Energy Recharge +20% |
...
<table>
  <thead>
    <tr>
      ...
      <th style="text-align:center">Char Lvl</th>
      <th style="text-align:center">Weap Lvl</th>
      <th style="text-align:center">Talent Lvl</th>
      <th style="text-align:center">Artifacts</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style="text-align:left"><b>Main DPS</b>
      </td>
      <td style="text-align:center">40/50</td>
      <td style="text-align:center">50/50</td>
      <td style="text-align:center">2</td>
      <td style="text-align:center">
        <p>+8 on 4&#x2605; with mainstat</p>
        <p>+0 otherwise</p>
      </td>
    </tr>
    <tr>
...
|  | Set | Pieces | Effect |
| :--- | :--- | :--- | :--- |
| ![](../.gitbook/assets/gladiator_flower.png) | Gladiator | 2 | ATK +18% |
| ![](../.gitbook/assets/gladiator_flower.png) | Gladiator | 4 | Increases Normal Attack and Charged Attack DMG by 35% |
| ![](../.gitbook/assets/berserker_flower.png) | Berserker | 2 | CRIT Rate +12% |
| ![](../.gitbook/assets/sojourner_flower.png) | Resolution of Sojourner | 2 | ATK +18% |
| ![](../.gitbook/assets/braveheart_flower.png) | Brave Heart | 2 | ATK +18% |
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:center">
        <p>+16 on 5&#x2605; with mainstat</p>
        <p>+12 on 4&#x2605; with mainstat</p>
        <p>+0 otherwise</p>
      </td>
    </tr>
    <tr>
...
* The exact artifact choices will be different for each character. Check out a [build guide](%20https://docs.google.com/spreadsheets/d/e/2PACX-1vRq-sQxkvdbvaJtQAGG6iVz2q2UN9FCKZ8Mkyis87QHFptcOU3ViLh0_PJyMxFSgwJZrd10kbYpQFl1/pubhtml) to see what is best for your choses character.
...
<table>
  <thead>
    <tr>
      ...
      <th style="text-align:center">Recommended Level</th>
  ...
  <tbody>
    <tr>
      <td style="text-align:center">
        <img src="../.gitbook/assets/gladiator_flower.png" alt/>
        <br />Flower</td>
      <td style="text-align:center">+12 / +16 / +20</td>
      <td style="text-align:left">
        <ul>
          <li>Least important piece for DPS</li>
          <li>Common drop with fixed mainstat</li>
          <li>Don&apos;t level unless it has <b>at least one CRIT stat</b>, preferably
            two</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td style="text-align:center">
        <p>
          <img src="../.gitbook/assets/gladiator_feather.png" alt/>
        </p>
        <p>Feather</p>
      </td>
    ...
    <tr>
      <td style="text-align:center">
        <p>
          <img src="../.gitbook/assets/gladiator_sands.png" alt/>
        </p>
        <p>Sands</p>
      </td>
      ...
      <td style="text-align:left">
        <ul>
          <li>Difficult to get correct mainstat on-set</li>
          <li>Level the first one you find on-set, ignoring substats</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td style="text-align:center">
        <p>
          <img src="../.gitbook/assets/gladiator_cup.png" alt/>
        </p>
        <p>Goblet</p>
      </td>
      <td style="text-align:center">+20</td>
      <td style="text-align:left">
        <ul>
          <li>Very difficult to get correct mainstat on-set</li>
          <li>Level the first one you find with the correct element in any set, ignoring
            substats</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td style="text-align:center">
        <p>
          <img src="../.gitbook/assets/gladiator_circlet.png" alt/>
        </p>
        <p>Circlet</p>
      </td>
      <td style="text-align:center">+20</td>
      <td style="text-align:left">
        <ul>
          <li>You should always choose a <b>CRIT</b> mainstat for DPS</li>
          <li>Very difficult to get CRIT on-set</li>
          <li>Level the first one you find on-set, ignoring substats</li>
          <li>Choose CRIT Rate or CRIT DMG depending on whichever gets you closer to
            a 1:2 ratio</li>
        </ul>
      </td>
    </tr>
