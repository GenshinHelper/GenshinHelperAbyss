...
* Hyperbloom (![](../../.gitbook/assets/hydro\_small.png)![](../../.gitbook/assets/dendro\_small.png)+![](../../.gitbook/assets/electro\_small.png)) and Aggravate (![](../../.gitbook/assets/dendro\_small.png)![](../../.gitbook/assets/electro\_small.png)) Teams are highly recommended for the first side, particularly Chambers 1 & 3.
* AoE focused teams with an ![](../../.gitbook/assets/anemo\_small.png) are highly recommended for the second side, particularly Chambers 1 & 3.
...
|                            |                                                               Side 1                                                               |                                         Side 2                                        |
| -------------------------- | :--------------------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------: |
| **Shieldbreakers**         | ![](../../.gitbook/assets/pyro\_small.png)/![](../../.gitbook/assets/cryo\_small.png)/![](../../.gitbook/assets/dendro\_small.png) | ![](../../.gitbook/assets/pyro\_small.png)![](../../.gitbook/assets/hydro\_small.png) |
| **Preferred DPS Elements** |                                            ![](../../.gitbook/assets/dendro\_small.png)                                            |                    ![](../../.gitbook/assets/anemo\_small.png)(CC)                    |
...
Be wary of the Earthguard's charging-up attack. If you can't kill it quickly enough without stunning it, it will gain massive resistance to the element from which it took the most damage. Combined with the ![](../../.gitbook/assets/electro\_small.png) Shield Node it can make it very resistant to damage.

![](../../.gitbook/assets/dendro\_small.png) DPS is a good choice as you can trigger Quicken easily because of the shield node.
...
| ![](../../.gitbook/assets/UI\_AvatarIcon\_Tighnari.png)![](../../.gitbook/assets/UI\_AvatarIcon\_Nahida.png)                                                                                                                                                              | Dendro based DPS            |
...
The second wave consists of three different Abyss Mages. Swirling them together with an ![](../../.gitbook/assets/anemo\_small.png) is an effective way to destroy 2/3 of the shields, leaving only one to break with your team.

If you do not swirl any shields, you'll need at least ![](../../.gitbook/assets/pyro\_small.png)![](../../.gitbook/assets/hydro\_small.png) on your team to break the shields.

Be careful getting Frozen by combined attacks on the last wave. ![](../../.gitbook/assets/anemo\_small.png) CC helps greatly here, but if you can't disable the enemies, try to focus down one type at a time so you don't have to deal with Freeze.

#### Character Recommendations

| Character                                                                                                                                                       | Function |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| ![](../../.gitbook/assets/ui\_avataricon\_venti.png)![](../../.gitbook/assets/ui\_avataricon\_sucrose.png)![](../../.gitbook/assets/ui\_avataricon\_kazuha.png) | Anemo CC |
...
| Character                                                                                                   | Function               |
| ----------------------------------------------------------------------------------------------------------- | ---------------------- |
| ![](../../.gitbook/assets/ui\_avataricon\_zhongli.png)![](../../.gitbook/assets/ui\_avataricon\_kokomi.png) | Strong shielder/healer |
...
Be careful when using characters like Bennett that apply![](https://lh5.googleusercontent.com/yb7-D1O89ihX2eREABBlcrDTJRrINL434Al88AeYvb4nicJOS7NtfNFPWbd6INMTbkmIgqGIeaOK57SGlMRLxWZWtVMo9F8DME5x535RTsVaSUP7VL-0HN9aeQXR9wyjAYEEv9ep1WndpnkhOT4lDvo)to your character. The Cryo variant's slam attack does significant damage, and this will cause it to Melt for increased damage.

Also, be careful of characters that self-apply ![](../../.gitbook/assets/hydro\_small.png), even if momentarily. These are characters like Kokomi or Xingqiu, as the short time you’re frozen can be enough to kill you.
...
{% embed url="https://thumbs.gfycat.com/VillainousResponsibleGermanpinscher-mobile.mp4" %}
...
|                            |                                           Side 1                                          |                                             Side 2                                             |
| -------------------------- | :---------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------: |
| **Shieldbreakers**         |                       ![](../../.gitbook/assets/electro\_small.png)                       |                                                                                                |
| **Preferred DPS Elements** | ![](../../.gitbook/assets/electro\_small.png)![](../../.gitbook/assets/dendro\_small.png) | ![](../../.gitbook/assets/anemo\_small.png)(CC) ![](../../.gitbook/assets/physical\_small.png) |
| **Avoid DPS Elements**     |                                                                                           |                                                                                                |
...
If your team composition allows it, you can bring both ![](https://lh4.googleusercontent.com/bphoQMziDc7K\_l40gHPfg3NS81jG9QCX9Fg3n05zlqTakD-VdJ1Gwz7BAYXAByC\_YdtfUbVHjvauD51Zw-0flCtHNkJBTWnCfgn3fLPYE5D7jHv406oSpfoEpHycAS4Qim4nV3VEvB51gz4yXVEKz44)+![](https://lh4.googleusercontent.com/0Smwss-l1MAhZ2hxq2tSf25uhE-ic7i13lUq3wMmAvUk2oZIBsWENiOBK7w34plvPfNksNWPBBTReZEF7t\_9tiT4h-FRrTOyh2SG9\_7G-W7laAvwMdcKherSDz2Ysh8cU278j62gLc4iBc2nZVchnBY) as using Quicken is the fastest way to break invisibility, however this may not be worth lowering your damage for, as usually just![](https://lh4.googleusercontent.com/m4gIA4CgSb9NvHT0\_6Ut2rUpIGJ-AbMx41bFvI6\_hQEkbmsJ9T0Z0KY77jDjNYqRj-dLZxoEuud\_s5BbhVJzIDayi1jUwFmgl05UFUIiTvemvJfpH9oFWRkiOWcm3\_88TCvFFl5meuMBKB6Ix16Z2I0) will be enough.

If you skip bringing ![](https://lh3.googleusercontent.com/JtxoW\_tT0C2q33agjd-BZlhqplTiry-\_rjVsqp-30QY9uAU6RDtFGKw-CKJV9j5LS6X0ZWxEQkxXvIiiYchmFxcAd4ZoSCXAcebuukMbdviXolYz\_kWcckta\_tpcrmX09vd6cMkA0IntKKJ12qPFVvE), then you can simply deal damage to the boss during windows when it is repairing the components you destroyed. However this allows it to unleash additional attacks after repairing the components which may make the fight more difficult.
...
An ![](../../.gitbook/assets/anemo\_small.png) grouper such as Venti or Kazuha really helps as you can kill the summons while damaging the Eremites.
